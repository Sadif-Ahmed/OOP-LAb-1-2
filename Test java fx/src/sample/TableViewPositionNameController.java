...
public class TableViewPositionNameController {
    @FXML
    ...
    public void load() throws Exception{
        ...
        List = PlayerInfoBeta.getObservablePlayerlsit(SearchingPlayer.Search_by_Position(Position_Name,TempClub.Players));
