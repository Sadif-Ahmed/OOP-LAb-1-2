...
public class TableViewSalaryRangeNameController {
    @FXML
    ...
    public TableViewSalaryRangeNameController() {
    }
    ...
    public void load() throws Exception{
        ...
        List = PlayerInfoBeta.getObservablePlayerlsit(SearchingPlayer.Search_by_SalaryRange(Min_Range,Max_Range,TempClub.Players));
