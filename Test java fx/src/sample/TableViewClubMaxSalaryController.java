...
public class TableViewClubMaxSalaryController {
    @FXML
    ...
    public void load() throws Exception{
        ...
        List = PlayerInfoBeta.getObservablePlayerlsit(ClubSearch.Search_Club_Highest_Salary(Club_Name,TempClub.Players));
